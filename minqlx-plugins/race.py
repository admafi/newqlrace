...
G_AND_MG = ("blockworld", "caep4", "climbworld", "df_etleague", "df_extremepkr", "df_handbreaker4", "df_lickape",
            ...
            "bdfcomp042", "dfwc2017_6", "dfwc04_2")
...
_RE_POWERUPS = re.compile(r'print ".+\^3 got the (Haste|Battle Suit|Quad Damage|Invisibility|Regeneration|Mega Health|Red Armor)!\^7\n"')
